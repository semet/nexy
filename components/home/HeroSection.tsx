	...
	return (
		<div className="absolute flex flex-col space-y-8 top-[300px] lg:top-[350px] left-[60px] lg:left-[130px]">
			...
			<div className="flex items-center space-x-4">
				...
				<button className="px-3 lg:px-5 py-2 lg:py-3 flex justify-between items-center space-x-4 bg-gradient-to-r from-[#564fd2] to-[#2784a9b5] hover:bg-gradient-to-r hover:from-[#2784a9b5] hover:to-[#564fd2] text-white shadow-lg hover:shadow-xl rounded-3xl">
					<span className="text-md lg:text-lg">Fork me</span>
