...
const AboutUsSection = () => {
	return (
		...
		>
			<div className="w-full lg:w-[60%] flex flex-col space-y-6 md:px-16 xl:space-y-4 lg:pl-16 lg:pr-4 py-4 text-center lg:text-left">
				...
				<div className="flex justify-between flex-col md:flex-row items-center bg-blue-200 p-4 text-base shadow-lg rounded-xl italic">
